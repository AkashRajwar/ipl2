...
function main() {
  csv()
    ...
    .then(matches => {
      ...
      saveMatchesPlayedPerYear(result, result2, result3, result4, result5, result6, result7);
    });
  });
}

function saveMatchesPlayedPerYear(result, result2, result3, result4, result5, result6, result7) {
  const jsonData = {
